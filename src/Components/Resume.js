  ...
  render() {
    ...
    if(this.props.data){
      ...
      var extracurriculars = this.props.data.extracurriculars.map(function(extracurriculars){
        return <div key={extracurriculars.title}><h3>{extracurriculars.title}</h3>
            <p className="info">{extracurriculars.organization}<span>&bull;</span> <em className="date">{extracurriculars.years}</em></p>
    ...
    <div className="row extracurricular">
